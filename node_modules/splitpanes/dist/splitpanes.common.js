...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_splitpanes_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* harmony default export */ var splitpanesvue_type_script_lang_js_ = ({
  ...
  methods: {
    updatePaneComponents: function updatePaneComponents() {
      ...
      this.$children.forEach(function (paneComponent) {
        paneComponent.update(_defineProperty({}, _this.horizontal ? 'height' : 'width', "".concat(_this.indexedPanes[paneComponent._uid].size, "%")));
      });
    },
    ...
    onPaneAdd: function onPaneAdd(pane) {
      ...
      if (this.ready) {
        // 2. Add the splitter.
        this.redoSplitters(); // 3. Resize the panes.
        ...
        this.$emit('pane-add', {
          index: index,
          panes: this.panes.map(function (pane) {
            return {
              min: pane.min,
              max: pane.max,
              size: pane.size
    ...
    onPaneRemove: function onPaneRemove(pane) {
      ...
      this.resetPaneSizes({
        removedPane: _objectSpread({}, removed, {
          index: index
        })
    ...
    initialPanesSizing: function initialPanesSizing() {
      ...
      if (leftToAllocate > 0.1) {
        this.panes.forEach(function (pane) {
          if (pane.size === null) {
            pane.size = Math.max(Math.min(leftToAllocate / (_this7.panesCount - definedSizes), pane.max), pane.min);
          }
    ...
    readjustSizes: function readjustSizes(leftToAllocate, ungrowable, unshrinkable) {
      ...
      if (leftToAllocate > 0) equalSpaceToAllocate = leftToAllocate / (this.panes.length - ungrowable.length);else equalSpaceToAllocate = leftToAllocate / (this.panes.length - unshrinkable.length); // debugger
    ...
    dblClickSplitter: function dblClickSplitter(enable) {
      ...
      splitters.forEach(function (splitter, i) {
        splitter.ondblclick = enable ? function (event) {
          return _this9.onSplitterDblClick(event, i);
        } : undefined;
      });
    }
  },
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"4f80fe45-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/splitpanes/pane.vue?vue&type=template&id=4365279a&
var panevue_type_template_id_4365279a_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"splitpanes__pane",style:(_vm.style)},[_vm._t("default")],2)}
var panevue_type_template_id_4365279a_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/splitpanes/pane.vue?vue&type=template&id=4365279a&
...
var pane_component = normalizeComponent(
  ...
  panevue_type_template_id_4365279a_render,
  panevue_type_template_id_4365279a_staticRenderFns,
  false,
  null,
  null,
  null
...
/* concated harmony reexport Pane */__webpack_require__.d(__webpack_exports__, "Pane", function() { return splitpanes_pane; });
